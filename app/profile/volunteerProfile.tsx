        ...
        <View style={styles.sectionContent}>
          {activeTab === "posts" && (
            <EmptyStateCard
              icon="paw"
              title="No posts yet."
              subtitle="Share your rescue stories and updates with the community."
            />
          )}
          ...
          {activeTab === "reports" && (
            <EmptyStateCard
              ...
              subtitle="Your submitted reports and rescue activities will appear here."
            />
          )}
          ...
          {activeTab === "saved" && (
            <EmptyStateCard
              ...
              subtitle="Save important community posts or adoption profiles to view them later."
            />
          )}
        </View>
      </ScrollView>  
